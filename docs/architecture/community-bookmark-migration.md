...
5. Compare PDS community/metadata records with the rendered library; verify the second run is a no-op and no legacy records are created.
6. Soak development before requesting separate production approval. Production migration and REST removal are not part of this rollout.
